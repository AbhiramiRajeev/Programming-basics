...
func main() {
    fmt.Println(moveZerosToEnd([]int{0, 1, 0, 3, 12})) // Output: [1, 3, 12, 0, 0]
    fmt.Println(moveZerosToEnd([]int{1, 0, 2, 0, 3})) // Output: [1, 2, 3, 0, 0]
    fmt.Println(moveZerosToEnd([]int{0, 0, 1})) // Output: [1, 0, 0]
    fmt.Println(moveZerosToEnd([]int{4, 5, 0, 6, 0, 7})) // Output: [4, 5, 6, 7, 0, 0]
    fmt.Println(moveZerosToEnd([]int{0, 0, 0})) // Output: [0, 0, 0]
}
