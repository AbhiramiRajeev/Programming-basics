...
func subarrayWithSum(arr []int, target int) []int {
    // Implement the function here
    return []int{}
}

func main() {
    fmt.Println(subarrayWithSum([]int{1, 2, 3, 7, 5}, 12))  // Output: [2, 4]
    fmt.Println(subarrayWithSum([]int{1, 4, 20, 3, 10, 5}, 33)) // Output: [2, 4]
    fmt.Println(subarrayWithSum([]int{1, 2, 3, 4, 5}, 15)) // Output: [0, 4]
    fmt.Println(subarrayWithSum([]int{5, 6, 7, 8, 9}, 50)) // Output: []
    fmt.Println(subarrayWithSum([]int{1, 2, 3, 4, 5, 6}, 6)) // Output: [0, 2]
}
