...
Return the starting and ending indices (0-based). If no such subarray exists, return an empty list.
...
# Test Cases
print(subarray_with_sum([1, 2, 3, 7, 5], 12))  # Output: [2, 4]
print(subarray_with_sum([1, 4, 20, 3, 10, 5], 33))  # Output: [2, 4]
print(subarray_with_sum([1, 2, 3, 4, 5], 15))  # Output: [0, 4]
print(subarray_with_sum([5, 6, 7, 8, 9], 50))  # Output: []
print(subarray_with_sum([1, 2, 3, 4, 5, 6], 6))  # Output: [0, 2]
